...
export default function StockCard({ stock, productName, onAdjust, onDelete }: StockCardProps) {
  ...
  return (
    ...
    >
      ...
      <div style={{ 
        ...
        <p style={{ margin: '0 0 0.25rem 0', color: '#666', fontSize: '0.85rem' }}>Current Stock</p>
        <p style={{ 
          margin: 0, 
          fontSize: '2rem', 
          fontWeight: 'bold', 
